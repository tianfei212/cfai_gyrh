...
func NewBackgroundPromptHandler(repo *db.BackgroundPromptRepo, storageService storage.StorageService, qwenAdvisor qwen.Advisor, categoryRepo *db.BackgroundCategoryRepo) *BackgroundPromptHandler {
